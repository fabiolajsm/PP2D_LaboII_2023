...
namespace Entidades
{
    public static class DatosEnMemoria
    {
        ...
        private static readonly List<Usuario> listaUsuarios = new List<Usuario>()   
        {
            ...
            new Vendedor("Petunia", "Mostaza", "petunia@gmail.com", "jejeje"),
            new Vendedor("Roberto", "Yalo", "roberto@gmail.com", "5000"),
        ...
        /// <summary>
        /// Obtiene una copia de la lista de productos en los Datos en memoria
        /// </summary>
        /// <returns>List<Producto> copia de la lista de productos</returns>
