...
namespace Suarez_Fabiola_2D_2023
{
    public static class DatosEnMemoria
    {
        ...
        {
            new Producto("Bistec de soja", "Corte de proteína de soja con sabor a carne", "Bistec", 12, 20),
            new Producto("Seitan", "Corte de proteína de trigo con textura similar a la carne", "Seitan", 10.99, 15),
            new Producto("Filete de tempeh", "Corte de proteína de soja fermentada con sabor a nuez", "Filete", 99.9, 10),
